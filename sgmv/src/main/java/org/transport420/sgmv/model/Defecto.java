...
public class Defecto {
	...
	private String reportado_ver_por;
	...
	public Defecto(int idsgmv_defecto, String descripcion, String reportado_ver_por,
	...
	public String getReportado_ver_por() {
		return reportado_ver_por;
	}

	public void setReportado_ver_por(String reportado_ver_por) {
		this.reportado_ver_por = reportado_ver_por;
	}
