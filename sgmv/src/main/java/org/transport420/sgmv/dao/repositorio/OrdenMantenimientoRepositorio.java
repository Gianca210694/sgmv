...
public class OrdenMantenimientoRepositorio implements IOrdenMantenimientoRepositorio {
	...
	public List<OrdenMantenimiento> listarOrdenesMantenimiento(OrdenesMantenimientoFilterBean filterBean)
		...
		try {
			...
			String query = "{CALL sgmv.sp_listar_ordenes_mantenimiento(?, ?)}";
	...
	public OrdenMantenimiento crearOrdenMantenimiento(OrdenMantenimiento ordenMantenimiento) throws Exception {
		...
		try {
			...
			String queryOrdenMantenimiento = "{CALL sgmv.sp_crear_orden_mantenimiento(?, ?, ?, ?, ?, ?, ?, ?)}";
			String queryActividades = "{CALL sgmv.sp_crear_orden_mantenimiento_actividad(?, ?, ?, ?, ?, ?)}";
			String queryDefectos = "{CALL sgmv.sp_crear_orden_mantenimiento_defecto(?, ?, ?, ?, ?, ?)}";
			String queryEquipos = "{CALL sgmv.sp_crear_orden_mantenimiento_equipo(?, ?, ?, ?, ?)}";
	...
	public OrdenMantenimiento obtenerOrdenMantenimiento(int idsgmv_orden_mantenimiento) throws Exception {
		...
		try {
			con = MySqlDAOFactory.obtenerConexion();
			String query = "{CALL sgmv.sp_obtener_orden_mantenimiento(?)}";
			CallableStatement stmt = con.prepareCall(query);
			...
			while (rs.next()) {
				...
				act.setEjecutado_por(rs.getString("ejecutado_por"));
			...
			while (rs.next()) {
				...
				def.setReportado_ver_por(rs.getString("reportado_ver_por"));
			...
			while (rs.next()) {
				...
				eqp.setInspeccionado_por(rs.getString("inspeccionado_por"));
	...
	public OrdenMantenimiento editarOrdenMantenimiento(OrdenMantenimiento ordenMantenimiento) throws Exception {
		...
		try {
			con = MySqlDAOFactory.obtenerConexion();
			con.setAutoCommit(false);
			String query = "{CALL sgmv.sp_editar_orden_mantenimiento(?, ?, ?, ?, ?, ?, ?, ?)}";
			String queryActividades = "{CALL sgmv.sp_crear_orden_mantenimiento_actividad(?, ?, ?, ?, ?, ?)}";
			String queryDefectos = "{CALL sgmv.sp_crear_orden_mantenimiento_defecto(?, ?, ?, ?, ?, ?)}";
			String queryEquipos = "{CALL sgmv.sp_crear_orden_mantenimiento_equipo(?, ?, ?, ?, ?)}";
	...
	public void eliminarOrdenMantenimiento(int idsgmv_orden_mantenimiento) throws Exception {
		...
		try {
			con = MySqlDAOFactory.obtenerConexion();
			String query = "{CALL sgmv.sp_eliminar_orden_mantenimiento(?)}";
			CallableStatement stmt = con.prepareCall(query);
			stmt.setInt("pIdsgmv_orden_mantenimiento", idsgmv_orden_mantenimiento);
			stmt.execute();
		} catch (Exception e) {
