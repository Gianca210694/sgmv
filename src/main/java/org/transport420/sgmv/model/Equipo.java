...
public class Equipo {
	...
	private Empleado inspeccionado_por;
	private int ok;
	...
	public Equipo(int idsgmv_equipo, String descripcion, Empleado inspeccionado_por, int ok) {
		super();
	...
	public Empleado getInspeccionado_por() {
		return inspeccionado_por;
	}

	public void setInspeccionado_por(Empleado insepeccionado_por) {
