...
public class Usuario {
	...
	public Usuario(int idsgmv_usuario, String usuario, String contrasena, int idsgmv_empleado, int estado, String token,
			String captcha_response, String mensaje_respuesta, int primera_vez, List<Rol> roles, List<Modulo> modulos) {
		super();
	...
	public int getPrimera_vez() {
		return primera_vez;
	}
	
	public void setPrimera_vez(int primera_vez) {
		this.primera_vez = primera_vez;
	}
