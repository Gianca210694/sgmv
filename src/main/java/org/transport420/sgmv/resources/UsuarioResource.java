...
public class UsuarioResource {
	...
	@PUT
	@Path("/{usuarioId}")
	public void cambiarContrasena(@PathParam("usuarioId") int usuarioId, Usuario usuario) {
		usuario.setIdsgmv_usuario(usuarioId);
		empleadoServicio.cambiarContrasena(usuario);
	}
